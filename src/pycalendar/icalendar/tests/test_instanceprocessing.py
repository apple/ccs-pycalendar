...
BEGIN:VINSTANCE
RECURRENCE-ID:20160903T120000Z
CATEGORIES;INSTANCE-ACTION=UPDATE;X-PARAM=0:one-on-one
END:VINSTANCE
END:VEVENT
END:VCALENDAR
""",
...
""",
    ...
    {
        "title": "Remove one parameter from the instance",
        "compact": """BEGIN:VCALENDAR
VERSION:2.0
PRODID:test
BEGIN:VEVENT
...
DTSTART;VALUE=DATE:20160902
DURATION:PT1H
DESCRIPTION;LANGUAGE=en_US:My office
RRULE:FREQ=DAILY
SUMMARY:Master component
BEGIN:VINSTANCE
RECURRENCE-ID;VALUE=DATE:20160903
DESCRIPTION;INSTANCE-ACTION=UPDATE~LANGUAGE:My office
END:VINSTANCE
END:VEVENT
END:VCALENDAR
""",
...
""",
    ...
    {
        "title": "Remove and add one parameter from the instance",
        "compact": """BEGIN:VCALENDAR
VERSION:2.0
PRODID:test
BEGIN:VEVENT
...
BEGIN:VINSTANCE
RECURRENCE-ID;VALUE=DATE:20160903
DESCRIPTION;INSTANCE-ACTION=UPDATE~LANGUAGE;X-FOO=BAR:My office
END:VINSTANCE
END:VEVENT
END:VCALENDAR
""",
...
DTSTART;VALUE=DATE:20160903
DURATION:PT1H
DESCRIPTION;X-FOO=BAR:My office
SUMMARY:Master component
END:VEVENT
END:VCALENDAR
""",
...
""",
    ...
    {
        "title": "Two components no master",
        "compact": """BEGIN:VCALENDAR
VERSION:2.0
PRODID:test
BEGIN:VEVENT
...
BEGIN:VEVENT
UID:1234
RECURRENCE-ID;VALUE=DATE:20160904
